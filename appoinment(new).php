...
<head>
    ...
    <title>Appoinment Form(NEW)</title>
    ...
    <div class="main_section">
        ...
        <div class="appoint">
            ...
            <p class="content">A small river named Duden flows by their place and supplies it with the necessary regelialia. 
                ...
                Appoinment form for <strong>NEW</strong> patients.
            </p>
            <div class="old_form">
                <form action="appoinment(new).php" method="post" autocomplete="on">
                        <table>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="ptype" id="ptype" value="New" readonly></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td><label for="nda">Date of Appoinment :</label></td>
