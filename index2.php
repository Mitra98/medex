...
<div class="login-form-container" id="login-form-container">
    ...
    <form action="index2.php" method="post">
        <h3>For Login</h3>
        <span>Username</span>
        <input type="text" name="uname" class="box" placeholder="Enter your ph no/email" id="uname" required>
        <span>Password</span>
        <input type="password" name="pword" class="box" placeholder="Enter your password" id="pword" required>
...
<div class="signup-form-container" id="signup-form-container">
    ...
    <form action="index2.php" method="post">
        <h3>Register Form</h3>
        <span>Username</span>
        <input type="text" name="uname" class="box" placeholder="Enter your username" id="uname" required>
